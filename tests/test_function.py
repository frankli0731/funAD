...
class TestFunction():
    ...
    def test_init(self):
        ...
        assert fcn.x_dim ==1 and round(fcn.f(1),4) == 1.6526
        ...
        assert fcn2.x_dim ==2 and [round(fcn2.f(1,2)[0],4),round(fcn2.f(1,2)[1],4)] == [0.4108, 0.4108]
    ...
    def test_grad(self):
        ...
        f2 = funAD.function(lambda x :x[0]*x[1]*x[2]*x[3]*x[4])
